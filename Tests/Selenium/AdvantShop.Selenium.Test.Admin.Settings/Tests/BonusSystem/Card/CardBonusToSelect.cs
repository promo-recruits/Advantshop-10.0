...
{
    [TestFixture]
    public class CardBonusToSelect : BaseMultiSeleniumTest
    {
        [SetUp]
        ...
        public void AddToAllAdditionalBonuses()
        {
            ...
            VerifyAreEqual("120 основных и 0 дополнительных",
                Driver.FindElement(By.CssSelector("[data-e2e=\"countBonus\"] div")).Text,
        ...
        public void AddToAllMainBonuses()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"countBonus\"]")).Text
                    .Contains("120 основных и 0 дополнительных"), "last card additional bonuses added");
        }
    }
}
...
namespace AdvantShop.Selenium.Test.Admin.MySites.Tests.Funnel.AdminPanelActions.Settings
{
    ...
    public class AuthSettingsTest : MySitesFunctions
    {
        ...
        public void SetUpTest()
        {
            ...
            GoToClient(siteUrl);
            APItemSettingsClick();
            Driver.FindElement(By.Id("tabAccess")).Click();
            Driver.WaitForElem(By.CssSelector(".tab-content-active [data-e2e=\"RequireAuth\"]"));
        }
        ...
        {
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"RequireAuth\"] input")).GetAttribute("class")
                    .IndexOf("ng-not-empty") == -1, "require auth is not active");

            try
            {
                ReInitClient();
                GoToClient(siteUrl + "/funnelpage2");
        ...
        {
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            Driver.SendKeysInput(AdvBy.DataE2E("AuthRegUrl"), "https://advantshop.net");
            SaveModalSettings();
            ...
            try
            {
                ReInitClient();
                GoToClient(siteUrl + "/funnelpage2");
                VerifyAreEqual(BaseUrl + siteUrl + "/funnelpage2", Driver.Url, "page without auth settings");
                VerifyAreEqual(1, Driver.FindElements(By.ClassName("lp-block-text-single")).Count,
        ...
        [Test]
        public void CheckAuthWithRegUrlForNotMainPage()
        {
            GoToClient(siteUrl + "/funnelpage2");
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            Driver.SendKeysInput(AdvBy.DataE2E("AuthRegUrl"), "https://advantshop.net");
            ...
            try
            {
                ReInitClient();
                GoToClient(siteUrl);
                VerifyAreEqual(BaseUrl + siteUrl, Driver.Url, "page without auth settings");
                VerifyAreEqual(1, Driver.FindElements(By.ClassName("lp-block-text-single")).Count,
                    "displayed page content");
            ...
            {
                VerifyAddErrors("CheckAuthWithRegUrlForNotMainPage: " + ex.Message);
            }
            finally
            {
                ReInit();
        ...
        public void CheckAuthFilterRuleRegisteredRegistrate()
        {
            //registrate
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            SelectItem(AdvBy.DataE2E("AuthFilterRules"), "string:0", false);
            SaveModalSettings();
        ...
        public void CheckAuthFilterRuleHasProduct()
        {
            ...
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            Thread.Sleep(100);
            SelectItem(AdvBy.DataE2E("AuthFilterRules"), "string:1", false);
            Thread.Sleep(100);
            Driver.FindElement(By.LinkText("Выбрать товары")).Click();
            ...
            Driver.FindElements(By.ClassName("adv-modal-active"))[1]
                .FindElement(By.ClassName("blocks-constructor-btn-confirm")).Click();
            SaveModalSettings();
        ...
        [Test]
        public void CheckAuthFilterRuleHasProductWithoutSelectedProductNOTCOMPLETE()
        {
        ...
        [Test]
        public void CheckAuthFilterRuleHasLeadNOTCOMPLETE()
        {
            //проверяет покупателя, у которого есть неподходящий, и покупателя с подходящим лидом
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            SelectItem(AdvBy.DataE2E("AuthFilterRules"), "string:2", false);
        ...
        public void CheckAuthFilterRuleHasLeadByStatus()
        {
            ...
            SelectItem(AdvBy.DataE2E("AuthFilterRules"), "string:2", false);
            Thread.Sleep(100);
            SelectItem(AdvBy.DataE2E("SalesFunnels"), "string:3", false);
            Thread.Sleep(100);
            SaveModalSettings();
        ...
        [Test]
        public void CheckAuthFilterRuleHasLeadWithoutSelectedSalesFunnelNOTCOMPLETENOTCOMPLETE()
        {
        ...
        public void SetDefaultAuthSettings()
        {
            ...
            Driver.WaitForElem(By.CssSelector(".tab-content-active [data-e2e=\"RequireAuth\"]"));
            Driver.FindElement(AdvBy.DataE2E("RequireAuth")).Click();
            Driver.ClearInput(AdvBy.DataE2E("AuthRegUrl"));
            SelectItem(AdvBy.DataE2E("AuthFilterRules"), "string:0", false);
            SaveModalSettings();
        }

...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Columns.columnsThreeIcons.Button
{
    [TestFixture]
    public class columnsThreeIconsBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Columns\\columnsThreeIcons\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Columns\\columnsThreeIcons\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private readonly string FormBtn = "columnsThreeIconsBtn";

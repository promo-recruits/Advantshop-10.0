...
{
    [TestFixture]
    public class headerSimpleSettingsMenu : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerSimple\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\headerSimple\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerSimple\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "headerSimple";

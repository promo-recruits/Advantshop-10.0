...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderSimple.Button
{
    [TestFixture]
    public class headerSimpleBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerSimple\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerSimple\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

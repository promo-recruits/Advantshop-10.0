...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderCenter
{
    [TestFixture]
    public class headerCenterSettingsContacts : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Catalog.Product.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Catalog.Offer.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Catalog.Category.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Catalog.ProductCategories.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.CustomerGroup.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.Customer.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.Contact.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.Departments.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.Managers.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Customers.CustomerRoleAction.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.Landing.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingSettings.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingSite.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingSiteSettings.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\Settings.Settings.csv"
            );
            Init();
        }

        private readonly string blockName = "headerCenter";
        ...
        public void ContactsAllShow()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterEmail\"]")).Displayed,
                "email displayed in admin");
            VerifyAreEqual("mail@email.mail",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterEmail\"]")).Text, "email in admin");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterPhone\"]")).Displayed,
                "phone displayed in admin");
            VerifyAreEqual("+7(000)000-00-00",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterPhone\"]")).Text, "phone in admin");
            ...
            VerifyAreEqual("mail@email.mail",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterEmail\"]")).Text, "email in client");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterPhone\"]")).Displayed,
                "phone displayed in client");
            VerifyAreEqual("+7(000)000-00-00",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterPhone\"]")).Text, "phone in client");

...
{
    [TestFixture]
    public class headerCenterMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerCenter, ID блока: 1"), "name and id correct");
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCenterPhone\"]")).Displayed,
                "phone displayed");
            VerifyIsTrue(Driver.FindElement(By.CssSelector(".lp-menu-header")).Displayed, "menu displayed");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"HeadersBtn\"]"))[1].Displayed,
                "btn displayed");

...
{
    [TestFixture]
    public class headerCenterSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenter\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "headerCenter";
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-header-center")).GetAttribute("class")

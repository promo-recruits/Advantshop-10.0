...
{
    [TestFixture]
    public class headerCenterSimpleMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "headerCenterSimple";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerCenterSimple, ID блока: 1"), "name and id correct");

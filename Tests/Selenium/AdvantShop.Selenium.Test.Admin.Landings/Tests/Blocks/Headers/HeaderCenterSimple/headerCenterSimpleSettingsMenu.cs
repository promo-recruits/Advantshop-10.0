...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderCenterSimple
{
    [TestFixture]
    public class headerCenterSimpleSettingsMenu : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerCenterSimple\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenterSimple\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCenterSimple\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "headerCenterSimple";

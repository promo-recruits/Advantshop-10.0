...
{
    [TestFixture]
    public class headerCommunicationSimpleMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerCommunicationSimple, ID блока: 1"), "name and id correct");

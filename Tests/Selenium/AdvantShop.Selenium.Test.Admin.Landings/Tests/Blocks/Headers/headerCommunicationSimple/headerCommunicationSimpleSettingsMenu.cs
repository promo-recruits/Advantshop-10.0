...
{
    [TestFixture]
    public class headerCommunicationSimpleSettingsMenu : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockName = "headerCommunicationSimple";
        ...
        public void DesktopMenu()
        {
            ...
            VerifyAreEqual("О нас", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[0].Text,
                "initial 1st item client");
            VerifyAreEqual("Каталог", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[1].Text,
                "initial 2nd item client");
            VerifyAreEqual("Оплата", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[2].Text,
                "initial 3d item client");
            VerifyAreEqual("Доставка", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[3].Text,
                "initial 4th item client");
            VerifyAreEqual("Контакты", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[4].Text,
                "initial 5th item client");

            GoToMobile("lp/test1");
            Driver.FindElement(By.CssSelector("[data-e2e=\"BurgerMenuBtn\"]")).Click();
            Thread.Sleep(2000);
            VerifyAreEqual("О нас",
                Driver.FindElements(By.CssSelector("#block_1 .lp-menu-header-container--open .lp-link--text"))[0].Text,
                "initial 1st item admin");
            VerifyAreEqual("Каталог",
                Driver.FindElements(By.CssSelector("#block_1 .lp-menu-header-container--open .lp-link--text"))[1].Text,
                "initial 2nd item admin");
            VerifyAreEqual("Оплата",
                Driver.FindElements(By.CssSelector("#block_1 .lp-menu-header-container--open .lp-link--text"))[2].Text,
                "initial 3d item admin");
            VerifyAreEqual("Доставка",
                Driver.FindElements(By.CssSelector("#block_1 .lp-menu-header-container--open .lp-link--text"))[3].Text,
                "initial 4th item admin");
            VerifyAreEqual("Контакты",
                Driver.FindElements(By.CssSelector("#block_1 .lp-menu-header-container--open .lp-link--text"))[4].Text,
                "initial 5th item admin");
            ...
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .lp-menu-header")).Displayed, "menu is off");
        ...
        public void MenuItems()
        {
            ...
            VerifyIsTrue(
                ...
                0, "no menu items in burger-menu");

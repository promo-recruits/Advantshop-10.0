...
{
    [TestFixture]
    public class headerBurgerRightMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerBurgerRight, ID блока: 1"), "name and id correct");
            ...
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector(".lp-menu-header--burger-right div")).GetAttribute("class")

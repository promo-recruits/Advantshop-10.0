...
{
    [TestFixture]
    public class headerBurgerRightSettingsContacts : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerBurgerRight\\Settings.Settings.csv"
            );
            Init();
        }

        private readonly string blockName = "headerBurgerRight";
        ...
        public void ContactsAllShow()
        {
            ...
            Thread.Sleep(2000);
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"HeadersEmail\"]")).Displayed,
                "email displayed in admin");
            VerifyAreEqual("mail@email.mail", Driver.FindElement(By.CssSelector("[data-e2e=\"HeadersEmail\"]")).Text,
                "email in admin");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"HeadersPhone\"]")).Displayed,
                "phone displayed in admin");
            VerifyAreEqual("+7(000)000-00-00", Driver.FindElement(By.CssSelector("[data-e2e=\"HeadersPhone\"]")).Text,
                "phone in admin");

...
{
    [TestFixture]
    public class headerBurgerSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "headerBurger";
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-header-burger")).GetAttribute("class")

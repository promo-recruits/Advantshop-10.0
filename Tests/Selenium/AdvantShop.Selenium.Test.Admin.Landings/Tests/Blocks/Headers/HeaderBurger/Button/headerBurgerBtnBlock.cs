...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderBurger.Button
{
    [TestFixture]
    public class headerBurgerBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

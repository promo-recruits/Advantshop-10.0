...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderBurger
{
    [TestFixture]
    public class headerBurgerSettingsContacts : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Catalog.Product.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Catalog.Offer.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Catalog.Category.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Catalog.ProductCategories.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.CustomerGroup.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.Customer.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.Contact.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.Departments.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.Managers.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Customers.CustomerRoleAction.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.Landing.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingSettings.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingSite.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\CMS.LandingSiteSettings.csv",
                "data\\Admin\\LandingTest\\Headers\\headerBurger\\Settings.Settings.csv"
            );
            Init();
        }

        private readonly string blockName = "headerBurger";
        ...
        public void ContactsAllShow()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerEmail\"]")).Displayed,
                "email displayed in admin");
            VerifyAreEqual("mail@email.mail",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerEmail\"]")).Text, "email in admin");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerPhone\"]")).Displayed,
                "phone displayed in admin");
            VerifyAreEqual("+7(000)000-00-00",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerPhone\"]")).Text, "phone in admin");
            ...
            VerifyAreEqual("mail@email.mail",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerEmail\"]")).Text, "email in client");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerPhone\"]")).Displayed,
                "phone displayed in client");
            VerifyAreEqual("+7(000)000-00-00",
                Driver.FindElement(By.CssSelector("[data-e2e=\"headerBurgerPhone\"]")).Text, "phone in client");

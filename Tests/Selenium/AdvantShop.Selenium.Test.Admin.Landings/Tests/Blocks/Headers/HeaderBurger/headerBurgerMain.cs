...
{
    [TestFixture]
    public class headerBurgerMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerBurger, ID блока: 1"), "name and id correct");
            VerifyIsTrue(Driver.FindElement(By.CssSelector(".lp-header-logo")).Displayed, "logo displayed");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"BurgerMenuBtn\"]")).Displayed,
            ...
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector(".lp-menu-header--burger div")).GetAttribute("class")

...
{
    [TestFixture]
    public class headerSettingsMenu : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\header\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\header\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\header\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "header";

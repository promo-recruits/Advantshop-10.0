...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.Header.Button
{
    [TestFixture]
    public class headerBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\header\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\header\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

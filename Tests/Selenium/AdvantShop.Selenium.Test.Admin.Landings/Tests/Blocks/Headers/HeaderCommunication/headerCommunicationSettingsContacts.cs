...
{
    [TestFixture]
    public class headerCommunicationSettingsContacts : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerCommunication\\Settings.Settings.csv"
            );
            Init();
        }
        ...
        public void ContactsAllShow()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCommunicationEmail\"]")).Displayed,

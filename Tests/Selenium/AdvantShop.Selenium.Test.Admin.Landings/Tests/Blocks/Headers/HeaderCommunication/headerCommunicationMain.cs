...
{
    [TestFixture]
    public class headerCommunicationMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "headerCommunication";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerCommunication, ID блока: 1"), "name and id correct");
            VerifyIsTrue(Driver.FindElement(By.CssSelector(".lp-header-logo")).Displayed, "logo displayed");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("[data-e2e=\"headerCommunicationPhone\"]")).Displayed,
                "phone displayed");

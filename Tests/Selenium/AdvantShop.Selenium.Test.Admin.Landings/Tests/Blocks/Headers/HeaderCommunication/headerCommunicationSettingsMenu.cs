...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Headers.HeaderCommunication
{
    [TestFixture]
    public class headerCommunicationSettingsMenu : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Headers\\headerCommunication\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCommunication\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Headers\\headerCommunication\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "headerCommunication";
        ...
        public void DesktopMenu()
        {
            ...
            VerifyAreEqual("Доставка", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[3].Text,
                "initial 4d item mobile");
            VerifyAreEqual("Контакты", Driver.FindElements(By.CssSelector("#block_1 .lp-link--text"))[4].Text,
                "initial 5d item mobile");

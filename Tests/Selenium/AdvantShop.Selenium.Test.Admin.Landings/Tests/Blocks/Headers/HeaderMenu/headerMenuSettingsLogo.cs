...
{
    [TestFixture]
    public class headerMenuSettingsLogo : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void LogoVisible()
        {
            ...
            VerifyIsFalse(Driver.FindElement(By.CssSelector(".lp-header-logo")).Displayed,
                "initial logo not displayed");

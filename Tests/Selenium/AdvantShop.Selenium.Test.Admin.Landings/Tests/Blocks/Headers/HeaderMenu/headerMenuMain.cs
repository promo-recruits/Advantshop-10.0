...
{
    [TestFixture]
    public class headerMenuMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("headerMenu, ID блока: 1"), "name and id correct");
            VerifyIsFalse(Driver.FindElement(By.CssSelector(".lp-header-logo")).Displayed, "logo displayed");
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector(".lp-menu-header--transform div div")).GetAttribute("class")

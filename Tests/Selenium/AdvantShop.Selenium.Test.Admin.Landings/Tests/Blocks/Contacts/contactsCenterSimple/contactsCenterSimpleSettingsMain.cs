...
{
    [TestFixture]
    public class contactsCenterSimpleSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void ChangePadding()
        {
            ...
            VerifyAreEqual("135px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-bottom"),
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-contacts-center-simple")).GetAttribute("class")

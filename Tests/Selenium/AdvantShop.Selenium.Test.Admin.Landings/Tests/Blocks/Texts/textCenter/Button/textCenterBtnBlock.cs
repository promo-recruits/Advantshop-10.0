...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Texts.textCenter.Button
{
    [TestFixture]
    public class textCenterBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Texts\\textCenter\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Texts\\textCenter\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private readonly string FormBtn1 = "textCenterBtn1";
        private readonly string FormBtn2 = "textCenterBtn2";

...
{
    [TestFixture]
    public class textCenterSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockText = "textCenterText";
        ...
        public void ChangeColorScheme()
        {
            ...
            Thread.Sleep(2000);
            Driver.FindElements(By.CssSelector(".color-viewer-inner"))[20].Click();
            Thread.Sleep(2000);
            Driver.FindElement(By.CssSelector("#modalSettingsBlock_colorSchemeCustom .blocks-constructor-btn-confirm"))
                .Click();
            Thread.Sleep(2000);
            VerifyAreEqual("rgba(0, 149, 192, 1)", Driver.FindElement(By.Id("block_1")).GetCssValue("background-color"),
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-text-single")).GetAttribute("class")
        ...
        public void WidthColumn()
        {
            ...
            VerifyIsTrue(Driver.FindElements(By.CssSelector("#block_1 .col-xs-12.col-md-4")).Count == 1,
                "block WidthColumn 4 admin");

            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("#block_1 .col-xs-12.col-md-4")).Count == 1,
                "block WidthColumn 4 desktop");

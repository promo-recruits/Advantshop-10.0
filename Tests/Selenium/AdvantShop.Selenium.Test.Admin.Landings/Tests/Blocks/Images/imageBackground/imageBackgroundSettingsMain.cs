...
{
    [TestFixture]
    public class imageBackgroundSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Images\\imageBackground\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Images\\imageBackground\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Images\\imageBackground\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "imageBackground";
        ...
        public void ChangePadding()
        {
            ...
            //change padding_top
            VerifyAreEqual("315px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top initial");
            BlockSettingsBtn(numberBlock);
            ...
            BlockSettingsSave();
            Thread.Sleep(2000);
            VerifyAreEqual("40px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top changed");

            //change padding_bottom
            VerifyAreEqual("315px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-bottom"),
        ...
        public void HiddenDesktop()
        {
            ...
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .image-background")).Displayed,
                "not displayed block in desktop");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 div")).GetAttribute("class")
        ...
        public void ShowOnPages()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .image-background")).Displayed,
                "on main page before");
            GoToClient("lp/test1/page1");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .image-background")).Displayed, "on page1 before");
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .image-background")).Displayed,
                "on main page after");
            GoToClient("lp/test1/page1");
            VerifyIsFalse(Driver.PageSource.Contains("#block_1 .image-background"), "on page1 after");

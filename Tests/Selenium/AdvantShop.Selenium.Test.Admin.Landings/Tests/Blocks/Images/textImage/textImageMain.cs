...
{
    [TestFixture]
    public class textImageMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "textImage";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("textImage, ID блока: 1"), "name and id correct");
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageTitle\"]")).Displayed,
                "displayed title in client");
            VerifyAreEqual("Вдохновляйся идеями",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageTitle\"]")).Text, "title in client");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageText\"]")).Displayed,
            ...
            VerifyAreEqual(
                ...
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageText\"]")).Text, "text in client");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImagePicture\"]")).Displayed,
                "displayed picture in client");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImagePicture\"] img")).GetAttribute("src")
                    .Contains("/areas/landing/frontend/images/texts/textImage.jpg"), "picture in client");
            ...
            VerifyAreEqual("Вдохновляйся идеями",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageTitle\"]")).Text, "title in mobile");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageText\"]")).Displayed,
                "displayed text in mobile");
            VerifyAreEqual(
                "Текст, от латинского textus «ткань; сплетение, связь, сочетание» — зафиксированная на каком-либо материальном носителе человеческая мысль; в общем плане связная и полная последовательность символов.",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImageText\"]")).Text, "text in mobile");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImagePicture\"]")).Displayed,
                "displayed picture in mobile");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"textImagePicture\"] img")).GetAttribute("src")
                    .Contains("/areas/landing/frontend/images/texts/textImage.jpg"), "picture in mobile");

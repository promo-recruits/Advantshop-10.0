...
{
    [TestFixture]
    public class textImageSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockText = "textImageText";
        ...
        public void ChangePadding()
        {
            ...
            //change padding_top
            VerifyAreEqual("35px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top initial");
            BlockSettingsBtn(numberBlock);
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-text-image-reverse")).GetAttribute("class")

...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Images.textImage
{
    [TestFixture]
    public class textImageEdit : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Images\\textImages\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Images\\textImages\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Images\\textImages\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "textImage";
        private string blockType = "Images";
        private readonly int numberBlock = 1;
        private readonly string blockTitle = "textImageTitle";
        private readonly string blockSubTitle = "textImageSubtitle";
        private readonly string blockText = "textImageText";
        ...
        public void InplacePicture()
        {
            ...
            GoToClient("lp/test1");
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("[data-e2e=\"textImagePicture\"] img[data-qazy]")).Count == 1,
                "lazy-load initial");

            ReInit();
            GoToClient("lp/test1");
            VerifyIsTrue(
                Driver.FindElement(By.Id("block_1")).FindElement(By.CssSelector("[data-e2e=\"textImagePicture\"] img"))
                    .GetAttribute("src").Contains("/areas/landing/frontend/images/texts/textImage.jpg"),
                "block picture initial");
            pathInit = Driver.FindElement(By.CssSelector("[data-e2e=\"textImagePicture\"] img")).GetAttribute("src");

            Driver.MouseFocus(By.CssSelector("[data-e2e=\"textImagePicture\"]"));
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"textImagePicture\"] img")).GetAttribute("src")
                    .Contains("pictures/landing"), "upload via PC");
            path = Driver.FindElement(By.CssSelector("[data-e2e=\"textImagePicture\"] img"))
        ...
        public void InplaceText()
        {
            ...
            VerifyAreEqual("New Text",
                Driver.FindElement(By.Id("block_1")).FindElement(By.CssSelector("[data-e2e=\"" + blockText + "\"]"))
                    .Text, "block text");
            Driver.FindElement(By.CssSelector("[data-e2e=\"textImagePicture\"]")).Click();
            Thread.Sleep(1000);

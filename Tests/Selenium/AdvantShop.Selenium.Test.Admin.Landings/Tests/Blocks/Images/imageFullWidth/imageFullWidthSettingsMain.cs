...
{
    [TestFixture]
    public class imageFullWidthSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void HiddenDesktop()
        {
            ...
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .lp-block-image-full-width")).Displayed,
                "not displayed block in desktop");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-image-full-width")).GetAttribute("class")
        ...
        public void ShowOnPages()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-block-image-full-width")).Displayed,
                "on main page after");
            GoToClient("lp/test1/page1");
            VerifyIsFalse(Driver.PageSource.Contains("#block_1 .lp-block-image-full-width"), "on page1 after");

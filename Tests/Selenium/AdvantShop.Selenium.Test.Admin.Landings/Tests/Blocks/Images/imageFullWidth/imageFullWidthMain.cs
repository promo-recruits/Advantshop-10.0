...
{
    [TestFixture]
    public class imageFullWidthMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "imageFullWidth";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("imageFullWidth, ID блока: 1"), "name and id correct");
            ...
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-block-image-full-width")).Displayed,
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"PictureBlock\"] img")).GetAttribute("src")
                    .Contains("/areas/landing/images/image/image_full_width.jpg"), "picture in client");
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"PictureBlock\"] img")).GetAttribute("src")
                    .Contains("/areas/landing/images/image/image_full_width.jpg"), "picture in mobile");

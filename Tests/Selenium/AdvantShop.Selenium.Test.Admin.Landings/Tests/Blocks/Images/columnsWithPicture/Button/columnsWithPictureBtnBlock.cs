...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Images.columnsWithPicture.Button
{
    [TestFixture]
    public class columnsWithPictureBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Images\\columnsWithPicture\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Images\\columnsWithPicture\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private readonly string FormBtn = "columnsWithPictureBtn";

...
{
    [TestFixture]
    public class columnsWithPictureSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-columns-with-picture")).GetAttribute("class")

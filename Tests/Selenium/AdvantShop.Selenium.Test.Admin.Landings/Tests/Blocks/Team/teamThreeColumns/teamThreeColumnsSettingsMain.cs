...
{
    [TestFixture]
    public class teamThreeColumnsSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockImage = "teamThreeColumnsPic";
        private string blockColHeader = "teamThreeColumnsHeader";
        private string blockColText = "teamThreeColumnsText";
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-team-three-columns")).GetAttribute("class")
        ...
        public void PhotoRounding()
        {
            ...
            GoToClient("lp/test1");
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector("[data-e2e=\"teamThreeColumnsPic\"]")).GetAttribute("class")

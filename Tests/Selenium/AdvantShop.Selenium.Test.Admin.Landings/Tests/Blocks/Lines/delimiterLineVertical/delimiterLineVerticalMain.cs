...
{
    [TestFixture]
    public class delimiterLineVerticalMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "delimiterLineVertical";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.PageSource.Contains("delimiterLineVertical, ID блока: 1"), "name and id correct");

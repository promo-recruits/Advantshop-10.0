...
{
    [TestFixture]
    public class delimiterLineHorizontalSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Lines\\delimiterLineHorizontal\\CMS.LandingForm.csv",
                "data\\Admin\\LandingTest\\Lines\\delimiterLineHorizontal\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Lines\\delimiterLineHorizontal\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

        private string blockName = "delimiterLineHorizontal";
        ...
        public void HiddenDesktop()
        {
            ...
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .lp-block-delimiter-line-horizontal")).Displayed,
                "not displayed block in desktop");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-delimiter-line-horizontal")).GetAttribute("class")
        ...
        public void ShowOnPages()
        {
            ...
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-block-delimiter-line-horizontal")).Displayed,
                "on main page after");
            GoToClient("lp/test1/page1");
            VerifyIsFalse(Driver.PageSource.Contains("#block_1 .lp-block-delimiter-line-horizontal"), "on page1 after");

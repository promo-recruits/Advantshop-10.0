...
{
    [TestFixture]
    public class LandingsCharacteristicsEdit : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockName = "characteristics";
        ...
        public void InplaceTable()
        {
            ...
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"TitleCharacteristics\"] .inplace-initialized")).Click();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"TitleCharacteristics\"] .inplace-initialized")).Clear();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"TitleCharacteristics\"] .inplace-initialized"))
                .SendKeys("New Title");

            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Click();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Clear();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]"))
                .SendKeys("New Category Characteristics");

            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Click();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Clear();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).SendKeys("New Name Characteristics");

            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"SubTitleCharacteristics\"] .inplace-initialized")).Click();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"SubTitleCharacteristics\"] .inplace-initialized")).Clear();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"SubTitleCharacteristics\"] .inplace-initialized"))
                .SendKeys("New SubTitle");

            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Click();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Clear();
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))
            ...
            VerifyAreEqual("New Name Characteristics",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Text, "name characteristics");
            VerifyAreEqual("New Value Characteristics",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Text, "value characteristics");
            VerifyAreEqual("New Category Characteristics",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Text,
                "Category characteristics");
            VerifyAreEqual("New SubTitle",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"SubTitleCharacteristics\"] .inplace-initialized")).Text,
                "subtitle characteristics");
            VerifyAreEqual("New Title",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"TitleCharacteristics\"] .inplace-initialized")).Text,
            ...
            VerifyAreEqual("New Name Characteristics",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Text,
                "name characteristics after refresh");
            VerifyAreEqual("New Value Characteristics",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Text,
        ...
        public void EditCharacteristicsSettingsAdd()
        {
            ...
            VerifyAreEqual("New Name 3",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]"))[2].Text,
                "Category characteristics new 2");
            VerifyAreEqual("name3",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[2].Text,
                "name characteristics new 2");
            VerifyAreEqual("value3",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[2].Text,
                "value characteristics new 2");

            VerifyAreEqual("name2.1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[5].Text,
                "name characteristics new 5");
            VerifyAreEqual("value2.1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[5].Text,
                "value characteristics new 5");

            VerifyAreEqual("name2.5",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[9].Text,
                "name characteristics new 10");
            VerifyAreEqual("value2.5",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[9].Text,
            ...
            VerifyAreEqual("New Name 1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]"))[1].Text,
            ...
            VerifyAreEqual("New Name 2",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]"))[3].Text,
                "Category characteristics drag 4");
            VerifyAreEqual("New Name 5",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]"))[4].Text,
            ...
            VerifyAreEqual("name1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[3].Text,
                "name characteristics drag 4");
            VerifyAreEqual("value1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[3].Text,
            ...
            VerifyAreEqual("name2.1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[6].Text,
                "name characteristics drag 2");
            VerifyAreEqual("value2.1",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[6].Text,
                "value characteristics drag 2");
            VerifyAreEqual("name2.3",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[7].Text,
                "name characteristics drag 3");
            VerifyAreEqual("value2.3",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[7].Text,
                "value characteristics drag 3");
            VerifyAreEqual("name2.2",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[8].Text,
                "name characteristics drag 4");
            VerifyAreEqual("value2.2",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[8].Text,
                "value characteristics drag 4");
        ...
        public void EditCharacteristicsSettingAddDel()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Count == 0,
            ...
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Count == 3,
                "count Category Characteristics settings");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Count == 2,
                "count Name Characteristics settings");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Count == 2,
            ...
            VerifyAreEqual("Нажмите сюда, чтобы добавить описание",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Text, "name characteristics 1");
            VerifyAreEqual("Нажмите сюда, чтобы добавить описание",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Text,
            ...
            VerifyAreEqual("Нажмите сюда, чтобы добавить описание",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsName\"]"))[1].Text,
                "name characteristics 2");
            VerifyAreEqual("Нажмите сюда, чтобы добавить описание",
                Driver.FindElement(By.Id("block_" + numberBlock))
                    .FindElements(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]"))[1].Text,
            ...
            Thread.Sleep(2000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).SendKeys("New Category Inplace");
            Thread.Sleep(2000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).Click();
            Thread.Sleep(2000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsName\"]")).SendKeys("New Name Inplace");
            Thread.Sleep(2000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).Click();
            Thread.Sleep(2000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CharacteristicsValue\"]")).SendKeys("New Value Inplace");
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector("[data-e2e=\"CategoryCharacteristics\"]")).Click();

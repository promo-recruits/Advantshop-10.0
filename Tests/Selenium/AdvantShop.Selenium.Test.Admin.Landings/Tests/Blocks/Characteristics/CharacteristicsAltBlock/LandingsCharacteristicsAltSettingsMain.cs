...
{
    [TestFixture]
    public class LandingsCharacteristicsAltSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void ShowTitles()
        {
            ...
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("#block_1 [data-e2e=\"TitleCharacteristicsAlt\"]")).Count == 0,
            ...
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("#block_1 [data-e2e=\"TitleCharacteristicsAlt\"]")).Count == 1,
            ...
            VerifyAreEqual("Характеристики",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"TitleCharacteristicsAlt\"]")).Text,
        ...
        public void ShowSubTitles()
        {
            ...
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("#block_1 [data-e2e=\"SubTitleCharacteristicsAlt\"]")).Count == 0,
                "no Characteristics title admin");
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsTrue(
            ...
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("#block_1 [data-e2e=\"SubTitleCharacteristicsAlt\"]")).Count == 1,
                "Characteristics title admin");
            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsTrue(
            ...
            VerifyAreEqual("Реализуй все с Advantshop",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"SubTitleCharacteristicsAlt\"]")).Text,
                "Characteristics title desktop text");
            GoToMobile("lp/test1");
            VerifyIsTrue(
                Driver.FindElements(By.CssSelector("#block_1 [data-e2e=\"SubTitleCharacteristicsAlt\"]")).Count == 1,

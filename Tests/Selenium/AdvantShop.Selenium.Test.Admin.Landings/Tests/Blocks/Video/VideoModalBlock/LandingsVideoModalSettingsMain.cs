...
{
    [TestFixture]
    public class LandingsVideoModalSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockNameClientfull = "lp-block-modal-video";
        private readonly string blockTitle = "TitleModalVideo";
        private readonly string blockSubTitle = "SubTitleModalVideo";
        private string blockContent = "ContentModalVideo";
        ...
        public void ChangePadding()
        {
            ...
            //change padding_top
            VerifyAreEqual("90px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top before");
            BlockSettingsBtn(numberBlock);
            ...
            VerifyAreEqual("90px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-bottom"),
        ...
        public void ShowSubTitles()
        {
            ...
            VerifyIsTrue(
                ...
                "sub title desktop");
            VerifyAreEqual(
                "Единая система для создания интернет-магазина.\r\nУправляйте не только магазином, но и своим бизнесом.",

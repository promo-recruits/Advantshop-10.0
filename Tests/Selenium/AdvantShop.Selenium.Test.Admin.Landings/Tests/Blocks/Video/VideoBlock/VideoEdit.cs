...
{
    [TestFixture]
    public class VideoEdit : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockName = "video";
        private string blockType = "Video";
        private int numberBlock = 1;
        private string blockNameClient = "lp-block-video";
        private string blockNameClientfull = "lp-block-video";
    }
}
...
{
    [TestFixture]
    public class coverTextLeftSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void BackgroundImageUpdate()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"img_picture\"]")).GetAttribute("src")
                    .Contains("/areas/landing/images/covers/cover_text_left.jpg"), "initial photo in background");
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left")).GetAttribute("class")
        ...
        public void WidthColumn()
        {
            ...
            VerifyIsTrue(select3.SelectedOption.Text.Contains("6 колонок"));

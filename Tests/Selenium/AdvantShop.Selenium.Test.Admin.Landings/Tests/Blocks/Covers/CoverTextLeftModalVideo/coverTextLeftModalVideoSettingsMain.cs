...
{
    [TestFixture]
    public class coverTextLeftModalVideoSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void BackgroundChangeBehaviour()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.Id("block_1")).GetAttribute("style").Contains("box-shadow: rgba(0, 0, 0, 0)"),
                "initial background without shadow");
        ...
        public void BackgroundImageUpdate()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"img_picture\"]")).GetAttribute("src")
                    .Contains("/areas/landing/images/covers/cover_text_left_modal_video.jpg"),
        ...
        public void ChangePadding()
        {
            ...
            //change padding_top
            VerifyAreEqual("195px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top initial");
            BlockSettingsBtn(numberBlock);
            ...
            VerifyAreEqual("195px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-bottom"),
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-desktop"), "block`s class before");
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-desktop"), "block`s class before on page1");
            GoToMobile("lp/test1");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
            ...
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-desktop"), "block`s class after");
            GoToClient("lp/test1/page1");
            Thread.Sleep(2000);
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
            ...
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-desktop"), "block`s class after on page1");
            GoToMobile("lp/test1");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
        ...
        public void HiddenMobile()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-mobile"), "block`s class before");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
                "not displayed block in mobile");
            GoToMobile("lp/test1/page1");
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-mobile"), "block`s class before on page1");
            VerifyIsFalse(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
            ...
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-mobile"), "block`s class after");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
                "displayed block in mobile");
            GoToMobile("lp/test1/page1");
            VerifyIsFalse(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-text-left-modal-video"))
                    .GetAttribute("class").Contains("hidden-device-mobile"), "block`s class after on page1");
            VerifyIsTrue(Driver.FindElement(By.CssSelector("#block_1 .lp-container")).Displayed,
        ...
        public void WidthColumn()
        {
            ...
            VerifyIsTrue(Driver.FindElements(By.CssSelector("#block_1 .col-xs-12.col-md-8")).Count == 1,
                "cover WidthColumn 8 admin");

            ReInitClient();
            GoToClient("lp/test1");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("#block_1 .col-xs-12.col-md-8")).Count == 1,
                "cover WidthColumn 8 desktop");

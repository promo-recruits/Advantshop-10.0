...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Covers.CoverVideoLeft.Button
{
    [TestFixture]
    public class coverVideoLeftBtnBlock : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Covers\\coverVideoLeft\\ManyBlocks\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Covers\\coverVideoLeft\\ManyBlocks\\CMS.LandingSubBlock.csv"
            );
            Init();
        }

...
{
    [TestFixture]
    public class coverVideoLeftSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void BackgroundImageUpdate()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"img_picture\"]")).GetAttribute("src")
                    .Contains("/areas/landing/images/covers/cover_video_left.jpg"), "initial photo in background");
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-video-left")).GetAttribute("class")

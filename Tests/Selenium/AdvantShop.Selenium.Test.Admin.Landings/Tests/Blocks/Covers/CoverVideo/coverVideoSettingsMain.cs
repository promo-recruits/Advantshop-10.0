...
{
    [TestFixture]
    public class coverVideoSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void BackgroundImageUpdate()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("[data-e2e=\"img_picture\"]")).GetAttribute("src")
                    .Contains("/areas/landing/images/covers/cover_video.jpg"), "initial photo in background");
        ...
        public void ChangePadding()
        {
            ...
            //change padding_top
            VerifyAreEqual("135px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-top"),
                "padding_top initial");
            BlockSettingsBtn(numberBlock);
            ...
            VerifyAreEqual("120px", Driver.FindElement(By.Id("block_1")).GetCssValue("padding-bottom"),
        ...
        public void HiddenDesktop()
        {
            ...
            VerifyIsTrue(
                Driver.FindElement(By.CssSelector("#block_1 .lp-block-cover-video")).GetAttribute("class")

...
{
    [TestFixture]
    public class LandingsCountdownSimpleMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "countdownSimple";
        ...
        private readonly string blockSubTitle = "SubTitleCountdownsimple";
        ...
        public void AddBlock()
        {
            ...
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"" + blockContent + "\"]")).Count == 1,
                "blockContent 1");
            VerifyIsTrue(Driver.FindElements(By.CssSelector(".lp-countdown-simple__item")).Count == 4,
                "item countdown");
            VerifyAreEqual("rgba(255, 255, 255, 1)",
                Driver.FindElement(By.Id("block_1")).GetCssValue("background-color"), "background color dark");
            VerifyAreEqual("До конца акции осталось",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"" + blockTitle + "\"]")).Text,
                "title desktop text");

            for (var i = 0; i < Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part")).Count; i++)

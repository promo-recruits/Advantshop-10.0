...
namespace AdvantShop.Selenium.Test.Admin.Landings.Tests.Blocks.Countdown.countdownSimple
{
    [TestFixture]
    public class LandingsCountdownSimpleSettings : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Countdown\\CountdownSimple\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Countdown\\CountdownSimple\\CMS.LandingSubBlock.csv"
            );

            Init();
        }

        private string blockName = "countdownsimple";
        private string blockType = "Counters";
        private readonly int numberBlock = 1;
        private string blockNameClient = "countdown-simple";
        private string blockNameClientfull = "countdown-simple";
        private readonly string blockTitle = "TitleCountdownsimple";
        private string blockSubTitle = "SubTitleCountdownsimple";
        private readonly string blockContent = "ContentCountdownsimple";
        ...
        public void CountdownTypeMinutes()
        {
            ...
            VerifyAreEqual("2", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[4].Text,
                "countdown elem: 4");
            VerifyAreEqual("9", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[5].Text,
                "countdown elem: 5");
            VerifyAreEqual("5", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[6].Text,
                "countdown elem: 6");
            var numb = Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[7].Text;
            for (var i = 0; i < 4; i++)
                VerifyAreEqual("0", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[i].Text,
                    "countdown elem: " + i);
            VerifyAreEqual("30",
                Driver.FindElement(By.CssSelector("[data-e2e=\"" + blockContent + "\"]")).GetAttribute("is-loop"),
                "Date Countdown");
            Thread.Sleep(2000);
            VerifyAreNotEqual(numb, Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[7].Text,
                "countdown ");
            ...
            VerifyAreEqual("4", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[5].Text,
                "countdown elem: 5");
            VerifyAreEqual("5", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[6].Text,
                "countdown elem: 6");
            for (var i = 0; i < 5; i++)
            ...
            VerifyAreEqual("5",
                Driver.FindElement(By.CssSelector("[data-e2e=\"" + blockContent + "\"]")).GetAttribute("is-loop"),
                "Date Countdown 2");
            VerifyIsTrue(Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part")).Count == 8,
                "count item 1");
        ...
        public void CountdownTypesDays()
        {
            ...
            var datatime = DateTime.Now.AddDays(11).ToString("dd.MM.yyyy HH:mm");
            ...
            VerifyAreEqual("1", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[0].Text,
                "countdown elem: 0");
            VerifyAreEqual("0", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[1].Text,
                "countdown elem: 1");
            VerifyAreEqual("2", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[2].Text,
                "countdown elem: 2");
            VerifyAreEqual("3", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[3].Text,
                "countdown elem: 3");
            VerifyAreEqual("5", Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part"))[4].Text,
                "countdown elem: 4");
            VerifyIsTrue(Driver.FindElements(By.CssSelector(".lp-countdown-simple__item-part")).Count == 8,
                "count item 1");
        ...
        public void InplaceHeaders()
        {
            ...
            Thread.Sleep(1000);
            Driver.FindElement(By.Id("block_" + numberBlock))
                .FindElement(By.CssSelector(".lp-countdown-simple__item-part")).Click();
            Thread.Sleep(1000);

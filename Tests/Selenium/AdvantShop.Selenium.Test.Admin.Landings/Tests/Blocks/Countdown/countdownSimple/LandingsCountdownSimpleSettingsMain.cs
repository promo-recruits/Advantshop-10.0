...
{
    [TestFixture]
    public class LandingsCountdownSimpleSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockNameClient = "countdown-simple";
        private readonly string blockNameClientfull = "countdown-simple";
        private readonly string blockTitle = "TitleCountdownsimple";
        private string blockSubTitle = "SubTitleCountdownsimple";
        private string blockContent = "ContentCountdownsimple";
        ...
        public void ChangeColorScheme()
        {
            ...
            VerifyAreEqual("rgba(255, 255, 255, 1)",
                Driver.FindElement(By.CssSelector("#block_1")).GetCssValue("background-color"),
            ...
            Driver.FindElement(By.CssSelector("#modalSettingsBlock_colorSchemeCustom .blocks-constructor-btn-confirm"))
                .Click();
            Thread.Sleep(2000);
            VerifyAreEqual("rgba(228, 73, 55, 1)",
                Driver.FindElement(By.CssSelector("#block_1")).GetCssValue("background-color"),
        ...
        public void ShowTitles()
        {
            ...
            GoToClient("lp/test1");
            BlockSettingsBtn(numberBlock);
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"show_title\"]")).Count == 0,
                "no setting title");
            VerifyIsTrue(Driver.FindElements(By.CssSelector("[data-e2e=\"show_subtitle\"]")).Count == 0,
                "no setting sub title");

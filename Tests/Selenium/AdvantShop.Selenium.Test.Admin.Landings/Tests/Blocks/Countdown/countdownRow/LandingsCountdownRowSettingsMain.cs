...
{
    [TestFixture]
    public class LandingsCountdownRowSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        public void SetupTest()
        {
            ...
            InitializeService.LoadData(
                ...
                "data\\Admin\\LandingTest\\Countdown\\CountdownRow\\CMS.LandingBlock.csv",
                "data\\Admin\\LandingTest\\Countdown\\CountdownRow\\CMS.LandingSubBlock.csv"
            );

            Init();
        }

        private string blockName = "countdownRow";
        private string blockType = "Counters";
        private readonly int numberBlock = 1;
        private readonly string blockNameClient = "countdown-row";
        private readonly string blockNameClientfull = "countdown-row";
        private readonly string blockTitle = "TitleCountdownrow";
        private string blockSubTitle = "SubTitleCountdownrow";
        private string blockContent = "ContentCountdownrow";

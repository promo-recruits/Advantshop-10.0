...
{
    [TestFixture]
    public class LandingsCountdownRowSettings : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private string blockNameClient = "countdown-row";
        ...
        public void CountdownTypesDays()
        {
            ...
            var datatime = DateTime.Now.AddHours(5).ToString("dd.MM.yyyy HH:mm");
            ...
            VerifyAreEqual("0", Driver.FindElements(By.CssSelector(".lp-countdown__item-part"))[0].Text,
                "countdown elem: 0");
            VerifyAreEqual("0", Driver.FindElements(By.CssSelector(".lp-countdown__item-part"))[1].Text,
                "countdown elem: 1");
            VerifyAreEqual("0", Driver.FindElements(By.CssSelector(".lp-countdown__item-part"))[2].Text,
                "countdown elem: 2");
            VerifyAreEqual("4", Driver.FindElements(By.CssSelector(".lp-countdown__item-part"))[3].Text,
                "countdown elem: 3");

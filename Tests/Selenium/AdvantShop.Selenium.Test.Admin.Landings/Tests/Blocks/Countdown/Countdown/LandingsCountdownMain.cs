...
{
    [TestFixture]
    public class LandingsCountdownMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockName = "countdown";
        private readonly string blockType = "Counters";
        private readonly int numberBlock = 1;
        private readonly string blockNameClient = "countdown";
        private string blockNameClientfull = "countdown";
        private readonly string blockTitle = "TitleCountdown";
        private readonly string blockSubTitle = "SubTitleCountdown";
        private readonly string blockContent = "ContentCountdown";
        ...
        public void AddBlock()
        {
            ...
            VerifyAreEqual("rgba(0, 0, 0, 0)", Driver.FindElement(By.Id("block_1")).GetCssValue("background-color"),
                "background color dark client");
            VerifyAreEqual("До конца акции осталось",
                Driver.FindElement(By.CssSelector("#block_1 [data-e2e=\"" + blockTitle + "\"]")).Text,

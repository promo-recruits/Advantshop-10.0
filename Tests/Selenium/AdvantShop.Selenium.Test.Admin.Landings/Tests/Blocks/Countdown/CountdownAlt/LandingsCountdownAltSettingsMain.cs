...
{
    [TestFixture]
    public class LandingsCountdownAltSettingsMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        private readonly string blockNameClient = "countdown-alt";
        private readonly string blockNameClientfull = "countdown-alt";
        private readonly string blockTitle = "TitleCountdownalt";
        private readonly string blockSubTitle = "SubTitleCountdownalt";
        private string blockContent = "ContentCountdownalt";
        ...
        public void ChangeColorScheme()
        {
            ...
            BlockSettingsBtn(numberBlock);
            var selectElem1 = Driver.FindElement(By.CssSelector("[data-e2e=\"ColorScheme\"]"));
            var select3 = new SelectElement(selectElem1);
            VerifyIsTrue(select3.SelectedOption.Text.Contains("Светлая"));

...
{
    [TestFixture]
    public class LandingsCountdownAltMain : LandingsFunctions
    {
        [OneTimeSetUp]
        ...
        public void AddBlock()
        {
            ...
            VerifyAreEqual("rgba(255, 255, 255, 1)",
                Driver.FindElement(By.CssSelector("#block_1")).GetCssValue("background-color"), "background color");

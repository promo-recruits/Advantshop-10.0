...
namespace AdvantShop.Core.Services.Shipping.Grastin.Api
{
    ...
    public class BoxberryOrderContainer : GrastinBaseObject
    {
        [XmlElement("Method")]
        public override EnApiMethod Method
        {
            get { return EnApiMethod.NewOrderBoxberry; }
            set { throw new NotSupportedException("Setting the Method property is not supported"); }
        }

        [XmlArray("Orders")]
        [XmlArrayItem("Order")]
        public List<BoxberryOrder> Orders { get; set; }
    }

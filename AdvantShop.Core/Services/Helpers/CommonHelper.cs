...
namespace AdvantShop.Helpers
{
    public class CommonHelper
    {
        ...
        public static void SetCookie(string cookieName, string cookieValue, bool httpOnly = false, bool crossSubDomains = true, bool isSession = false)
        {
            SetCookie(cookieName, cookieValue, new TimeSpan(7, 0, 0, 0), httpOnly, crossSubDomains, isSession);
        }

        public static void SetCookie(string cookieName, string cookieValue, TimeSpan ts, bool httpOnly, bool crossSubDomains = true, bool isSession = false)
        {
            try
            {

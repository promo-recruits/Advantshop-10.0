...
{
    public static class OkMarketExportState
    {
        ...
        private const string FileLogPattern = "report_export_*.txt";
        ...
        public static void Start()
        {
            ...
            {
                _isRun = true;
                _fileLog = GetDirectory() + "report_export_" + DateTime.Now.ToString("yy-MM-dd_hh-mm") + ".txt";

...
namespace Tools
{
    public partial class SendMail : System.Web.UI.Page
    {
        ...
        protected void btnSendMail_Click(object sender, System.EventArgs e)
        {
            ...
            var mailSendsCount = (int)(Application["mailSendsCount"] ?? 0);

            if (mailSendsCount >= 50)
            {
                MsgErr("You have reached the maximum limit, sorry", false);
                return;
            }
            ...
            if (ValidForm())
            {
                ...
                string strResult;
                Application["mailSendsCount"] = mailSendsCount+1;

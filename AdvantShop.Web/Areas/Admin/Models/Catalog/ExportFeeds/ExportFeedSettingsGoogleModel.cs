...
namespace AdvantShop.Web.Admin.Models.Catalog.ExportFeeds
{
    public class ExportFeedSettingsGoogleModel : IValidatableObject
    {
        public ExportFeedSettingsGoogleModel(ExportFeedGoogleMerchantCenterOptions exportFeedGoogleMerchantCenterOptions)
        {
            ...
            OnlyMainOfferToExport = exportFeedGoogleMerchantCenterOptions.OnlyMainOfferToExport;
            ColorSizeToName = exportFeedGoogleMerchantCenterOptions.ColorSizeToName;
        }

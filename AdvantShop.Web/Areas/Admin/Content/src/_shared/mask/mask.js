(function () {
    ...
    angular.module('mask', [])
        .directive('maskControl', ['$parse', '$timeout', '$q', 'maskControlService', function ($parse, $timeout, $q, maskControlService) {
            return {
                restrict: 'A',
                require: {
                    ngModel: 'ngModel'
    ...
    angular.module('mask')
        .directive('maskConfig', ['maskControlService', function (maskControlService) {
            return {
                restrict: 'A',
                bindToController: true,
                priority: 100,
                ...
                controller: ['$scope', '$element', '$attrs', '$parse', function (scope, element, attrs, $parse) {
                    ...
                    var ctrl = this;
                    ctrl.$onInit = function () {
                        var config = $parse(attrs.maskConfig)(scope);

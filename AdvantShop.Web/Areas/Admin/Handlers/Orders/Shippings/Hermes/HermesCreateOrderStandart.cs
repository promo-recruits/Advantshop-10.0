...
{
    public class HermesCreateOrderStandart : HermesCreateOrder
    {
        public HermesCreateOrderStandart(int orderId) : base(orderId)
        {
        }
        ...
        public override string CreateOrder(Order order, Shipping.Hermes.Hermes hermesMethod, HermesCalculateOption hermesCalculateOption, OrderPickPoint orderPickPoint)
        {
            ...
            var parcel = new CreateStandardParcelParams
            {
            ...
            var result = client.CreateStandardParcel(parcel);

; (function (ng, body) {
    ...
    ng.module('app', dependencyService.get())
        .config(['$provide', '$compileProvider', '$cookiesProvider', '$httpProvider', '$localeProvider', '$translateProvider', '$locationProvider', 'ngFlatpickrDefaultOptions',
            function ($provide, $compileProvider, $cookiesProvider, $httpProvider, $localeProvider, $translateProvider, $locationProvider, ngFlatpickrDefaultOptions) {

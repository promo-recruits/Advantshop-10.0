...
namespace AdvantShop.Web.Infrastructure.Routing
{
    public class SubDomainRoute : Route
    {
        ...
        public SubDomainRoute(string subDomain, string area, string url, object defaults, string[] namespaces)
        ...
        {
            if (_area == SettingsDesign.Template || IsSubDomainExist(httpContext))
            {
